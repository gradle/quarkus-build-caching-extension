...
assertBuildCacheDisabled('04-fast-jar-build-cache-disabled.log')
assertBuildCacheMiss('05-fast-jar-build-cache-miss.log')
assertBuildCacheHit('06-fast-jar-build-cache-hit.log')
assertBuildCacheDisabled('07-native-build-cache-disabled.log')
assertBuildCacheMiss('08-native-build-cache-miss.log')
assertBuildCacheHit('09-native-build-cache-hit.log')
