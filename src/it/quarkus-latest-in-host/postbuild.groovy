// A native build with the local toolchain against the Quarkus snapshot, which is cacheable only once the in-container
...
assert new File(basedir, 'target/quarkus-test-latest-in-host-0.1-SNAPSHOT-runner').exists()
